        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            ...
            <div className="text-left">
              <div className="text-xs opacity-80">{downloadCTA.appStore.label}</div>
              <div className="text-lg font-semibold">{downloadCTA.appStore.store}</div>
            </div>
          </a>
          ...
          >
            ...
            <div className="text-left">
              <div className="text-xs opacity-80">{downloadCTA.playStore.label}</div>
              <div className="text-lg font-semibold">{downloadCTA.playStore.store}</div>
            </div>
          </a>
        </div>
      </div>
