...
export default function TrainingModes() {
  ...
  return (
    <section id="modes" className="py-16 sm:py-24 bg-gray-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          {/* Content */}
          <div>
            <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-secondary/20 text-gray-900 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              {trainingModes.modes.map((item, index) => (
                <div
                  key={index}
                  className="p-3 sm:p-4 bg-gray-800 rounded-lg sm:rounded-xl"
                >
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              {gridKeys.slice(0, 2).map((key, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-gray-800 rounded-xl sm:rounded-2xl overflow-hidden"
                  >
                    <Image
                      src={screenshot.src}
                      alt={screenshot.alt}
